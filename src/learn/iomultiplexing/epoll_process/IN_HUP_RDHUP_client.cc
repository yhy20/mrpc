...
int main()
{
    ...
    if(0 == pid)
    {
        ...
        /// wait for clnt_sock epoll_ctl and shutdown(clnt_sock, SHUT_RD).
        ...
        /// wait for PrintEvents to show EPOLLIN and EPOLLRDHUP events.
        sleep(5);

        /// shutdown to triggers EPOLLRDHUP and HUP.
